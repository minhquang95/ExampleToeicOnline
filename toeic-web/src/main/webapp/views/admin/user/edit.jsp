...
<c:url var="editUserUrl" value="/admin-user-edit.html">
                ...
                <form action="${editUserUrl}" method="post" id ="editUserForm">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="md-form">
                                    <input type="text" placeholder="Username" class="form-control" value="${item.pojo.name}" id="username" name="pojo.name" required/>
                                </div>
                            </div>
                            <br/>
                            <br/>
                            <div class="col-md-12">
                                <div class="md-form">
                                    <input type="text" placeholder="FullName" class="form-control" value="${item.pojo.fullName}" name="pojo.fullName"/>
                                </div>
                            </div>
                            <br/>
                            <br/>
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty item.pojo.userId}">
                                            <select>
                                                ...
                                                <c:forEach items="${item.roleList}" var="itemrole">
